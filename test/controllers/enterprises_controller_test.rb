...
class EnterprisesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create enterprise" do
    assert_difference("Enterprise.count") do
      post enterprises_url, params: { enterprise: { cnpj: @enterprise.cnpj, email: @enterprise.email, name: @enterprise.name, phone: @enterprise.phone, seller_id: @enterprise.seller_id } }
    end
  ...
  test "should update enterprise" do
    patch enterprise_url(@enterprise), params: { enterprise: { cnpj: @enterprise.cnpj, email: @enterprise.email, name: @enterprise.name, phone: @enterprise.phone, seller_id: @enterprise.seller_id } }
